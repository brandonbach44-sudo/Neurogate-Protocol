...
After defacing, visually inspect each file to confirm the face and ears are removed while brain tissue remains intact. Record the defacing tool name, version, and confirmation in your site's defacing log (per GOV-001 Section 5).
...
| 2.9 | August 2, 2026 | Brandon Bach | Removed SOP-PENNSIEVE-001 from Related Documents (retired per GOV-001 v1.15 -- the tool is a general organization tool, not tied to any specific upload target). Updated the parent GOV-001 reference to v1.15. |
